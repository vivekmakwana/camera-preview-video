...
public class CameraPreview extends CordovaPlugin implements CameraActivity.CameraPreviewListener {
  ...
  private static final String START_RECORDING_ACTION = "startRecording";
  private static final String STOP_RECORDING_ACTION = "stopRecording";
  ...
  private CallbackContext startRecordingCallbackContext;
  private CallbackContext stopRecordingCallbackContext;
  ...
  public boolean startRecording(CallbackContext callbackContext) {
    if (this.hasView(callbackContext) == false) {
      return true;
    }

    startRecordingCallbackContext = callbackContext;
  ...
  public void onStartRecordVideo() {
    ...
    pluginResult.setKeepCallback(true);
    startRecordingCallbackContext.sendPluginResult(pluginResult);
  }

  public void onStartRecordVideoError(String message) {
    Log.d(TAG, "CameraPreview onStartRecordVideo");
    startRecordingCallbackContext.error(message);
  }
  ...
  public void onStopRecordVideo(String file) {
    ...
    stopRecordingCallbackContext.success(file);
  }

  public void onStopRecordVideoError(String err) {
    Log.d(TAG, "onStopRecordVideo error");

    stopRecordingCallbackContext.error(err);
  }
}
