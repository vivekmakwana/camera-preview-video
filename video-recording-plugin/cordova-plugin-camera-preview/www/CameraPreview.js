...
CameraPreview.startRecording = function(onSuccess, onError) {
    exec(onSuccess, onError, PLUGIN_NAME, "startRecording", []);
};

CameraPreview.stopRecording = function(onSuccess, onError) {
    exec(onSuccess, onError, PLUGIN_NAME, "stopRecording", []);
};
